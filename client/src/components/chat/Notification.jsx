...
const {notifications, userChats, allUsers, markAllNotificationRead, markNotifications} = useContext(ChatContext);
    ...
    <span className="notification-count">
        ...
        {isOpen ?   <div className="notifications-box">
            <div className="notifications-header">
                ...
                onClick={() => markAllNotificationRead(notifications)}
                > Mark them Read</div> 
            </div>
            ...
            {modifiedNotifications && modifiedNotifications.map((n,index) => {
                ...
                onClick={() => {
                    markNotifications(n, userChats, user, notifications)
                    setIsOpen(false)
                }}> 
