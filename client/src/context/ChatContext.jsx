...
useEffect(() =>{
    ...
    const markNotifications = useCallback((n, userChats, user, notifications) => {
        //find cht open
    ...
    const markThisUserNotificationRead = useCallback((thisUserNotifications, notifications) =>{
        const mNotifications = notifications.map(el => {
            let notification;
